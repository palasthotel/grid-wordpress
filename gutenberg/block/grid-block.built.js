...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_src_component_the_grid_container_container_raw__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_src_component_the_grid_slot_slot__ = __webpack_require__(12);
...
var Gridenberg = function () {
    function Gridenberg() {
        var _this = this;

        _classCallCheck(this, Gridenberg);
    ...
    _createClass(Gridenberg, [{
        ...
        value: function save() {
            ...
            setTimeout(function () {
                var containers = _this2.containers.map(function (container) {
                    return {
...
var gridenberg = window.Gridenberg = new Gridenberg();
...
var GutenbergGridContainer = function (_Component) {
    ...
    function GutenbergGridContainer(props) {
        ...
        var _this3 = _possibleConstructorReturn(this, (GutenbergGridContainer.__proto__ || Object.getPrototypeOf(GutenbergGridContainer)).call(this));
    ...
    _createClass(GutenbergGridContainer, [{
        ...
        value: function getIndex() {
            ...
            containers.forEach(function (container, index) {
                if (container.isSameNode(_this4.el)) {
                    myIndex = index;
                }
            });
            return myIndex;
        ...
        value: function render() {
            ...
            return wp.element.createElement(
                ...
                wp.element.createElement(__WEBPACK_IMPORTED_MODULE_0__lib_src_component_the_grid_container_container_raw__["a" /* default */], {
                    index: index })
            );
        }
    }]);
...
GridGutenberg.containertypes.forEach(function (containertype) {
    ...
    registerBlockType('palasthotel/the-grid-container-' + containertype.type, {
        ...
        edit: function edit(props) {
            console.log("EDIT");
            return wp.element.createElement(GutenbergGridContainer, {
	...
	_createClass(Container, [{
			...
			return wp.element.createElement(
				...
				wp.element.createElement(
					...
					wp.element.createElement(
						...
						wp.element.createElement('i', { className: 'grid-icon__drag' })
					),
					wp.element.createElement(
						'div',
						...
						wp.element.createElement(
							...
							'Options ',
							wp.element.createElement('i', { className: 'grid-icon__options' })
						),
						wp.element.createElement(
							'ul',
							...
							wp.element.createElement(
								...
								wp.element.createElement('i', { className: 'grid-icon__edit' }),
								' Edit'
							),
							this.renderReuse(),
							wp.element.createElement(
								'li',
								{ className: 'grid-container__options--list-item' },
								wp.element.createElement('i', { className: 'grid-icon__style' }),
								' Slot-styles'
							),
							wp.element.createElement(
								'li',
								...
								wp.element.createElement('i', { className: 'grid-icon__trash' }),
								' Delete'
							)
						)
					)
		...
		value: function renderReuse() {
			...
			return wp.element.createElement(
				...
				wp.element.createElement('i', { className: 'grid-icon__reuse' }),
				' Reuse'
			);
		}
	...
	_createClass(Slot, [{
		...
		value: function render() {
			return wp.element.createElement(
				...
				wp.element.createElement(StyleChanger, null),
				wp.element.createElement(
					'div',
...
Slot.propTypes = {
	dimension: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number.isRequired
};

/* unused harmony default export */ var _unused_webpack_default_export = (Slot);
...
var StyleChanger = function (_Component2) {
  ...
  */
	function StyleChanger(props) {
		...
		return _possibleConstructorReturn(this, (StyleChanger.__proto__ || Object.getPrototypeOf(StyleChanger)).call(this, props));
	}
	/**
  * ---------------------
  * rendering
  ...
  */
	...
	_createClass(StyleChanger, [{
		key: 'render',
		value: function render() {
			return wp.element.createElement('div', { className: 'grid-slot__style-changer' });
		}
		/**
   * ---------------------
   * events
